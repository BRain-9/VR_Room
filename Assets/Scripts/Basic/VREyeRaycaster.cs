...
using UnityEngine;
    ...
    {
	    public static event Action<RaycastHit> OnRaycasthit;                   // This event is called every frame that the user's gaze is over a collider.
	    public static event Action OnRaycastOut;
	    ...
	    [SerializeField] private CameraFollow _camerFrontPivot;         // UI Interface
        ...
        private void OnEnable()
        {
		    ...
		    VRController.controllerEnable += (Transform t) => 
        		{
        			controllerTransform = t;
					m_Camera = t;
        		};
    		VRController.controllerDisable += (Transform t) =>
    		    {
